...
# SVN Id        $Id: PdfDocument.pm 185 2012-09-03 22:55:54Z mark.dootson@gmail.com $
...
package Wx::PdfLayer;             @ISA = qw( Wx::PdfOcg );
package Wx::PdfLayerMembership;   @ISA = qw( Wx::PdfOcg );
package Wx::PdfDC;                @ISA = qw( Wx::DC );
package Wx::PdfLink;
package Wx::PdfPageLink;          @ISA = qw( Wx::PdfLink );
package Wx::PdfPrinter;           @ISA = qw( Wx::Printer );
package Wx::PdfPrintData;         @ISA = qw( Wx::Object );
package Wx::PdfPrintPreview;      @ISA = qw( Wx::PrintPreview );
package Wx::PdfPrintPreviewImpl;  @ISA = qw( Wx::PrintPreview );
package Wx::PdfPageSetupDialog;   @ISA = qw( Wx::Dialog );
package Wx::PdfPrintDialog;       @ISA = qw( Wx::PrintDialog );
package Wx::PlPdfDocument;        @ISA = qw( Wx::PdfDocument );
